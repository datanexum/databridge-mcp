...
**268 MCP tools** across 38 modules for profiling, fuzzy matching, hash comparison, hierarchy building, dbt generation, and Snowflake deployment.
...
|---------|-------|---------|
| Community (CE) | 266 | `pip install databridge-ai` |
| Pro | ~300 | `pip install databridge-ai-pro` |
| Enterprise | 333+ | Private deployment |
