...
|---------|-------|---------|
| Community (CE) | 317 | `pip install databridge-ai` |
| Pro | ~350 | `pip install databridge-ai-pro` |
| Enterprise | 382 | Private deployment |
